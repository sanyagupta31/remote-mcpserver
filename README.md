...
On hosting platforms, configure `DATA_DIR` as the path to the provider's mounted
persistent disk. A writable persistent volume is required to save expenses across
restarts.
